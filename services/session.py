...
def get_history(session_id: str) -> list[dict]:
    """Return mutable message list for this session, creating or evicting if needed."""
    now = time.time()
...
def append_message(session_id: str, message: dict) -> None:
    """Append a message and immediately trim if exceeding the maximum history limit."""
