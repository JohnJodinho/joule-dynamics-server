"""
Configuration constants loaded from environment variables for Joule Dynamics backend.

Key settings:
  - MARKET_CACHE_TTL_SECONDS: Background refresh interval for market registry (default 300s).
  - GEOCODE_COUNTRY_FILTER: Optional ISO 3166-1 alpha-2 country code(s) to restrict Mapbox geocoding.
"""
